...
$USER_ID = $_SESSION['userLogginID'];
    ...
    .cb-slideshow li:nth-child(<?php echo $countBanner++ ?>) span {
        background:linear-gradient(270deg, rgba(0,0,0, 0.7), rgba(0,0,0,0.3)), url("<?php echo base_url('uploads/medium_thumb/'.$banner['picture_medium_name'])?>") !important;
        background-image:linear-gradient(270deg, rgba(0,0,0, 0.7), rgba(0,0,0,0.3)), url("<?php echo base_url('uploads/medium_thumb/'.$banner['picture_medium_name'])?>") !important;
        ...
        <div class="container-fluid">
            <div class="col-sm-8 col-sm-offset-2 no-padding-xs no-margin-xs">
                ...
                <div class="user_profile_menu text-center no-padding-xs no-padding-sm" style="padding-top: 0;margin-top: 10px; margin-bottom: -5px">
                    <ul>
                        <li><a href="<?php echo base_url('profile/') ?>" class="<?php if ($this->uri->segment(2)==''){echo 'active';}?>"><?php echo $countUploadPicture ?> Photos</a></li>
                        <li><a href="<?php echo base_url('profile/vote') ?>?page=#award" class="<?php if ($this->uri->segment(2)=='vote'){echo 'active';}?>">9 Vote</a></li>
                        <li><a href="<?php echo base_url('profile/contest') ?>?page=#contest" class="<?php if ($this->uri->segment(2)=='contest'){echo 'active';}?>"><?php echo $countContest ?> Contest</a></li>
                        <li class="hidden-xs"><a href="<?php echo base_url('profile/challenges') ?>?page=#challenges" class="<?php if ($this->uri->segment(2)=='challenges'){echo 'active';}?>"><?php echo $countChallenge ?> Challenges</a></li>
                        <li class="hidden-xs"><a href="<?php echo base_url('profile/followers') ?>?page=#followers" class="<?php if ($this->uri->segment(2)=='followers'){echo 'active';}?>"><?php echo $countFollowers ?> Followers</a></li>
                        <li class="hidden-xs"><a href="<?php echo base_url('profile/following') ?>?page=#following" class="<?php if ($this->uri->segment(2)=='following'){echo 'active';}?>">Following <?php echo $countFollowings; ?></a></li>
                        <li class="hidden-xs"><a href="<?php echo base_url('profile/about') ?>?page=#about" class="<?php if ($this->uri->segment(2)=='about'){echo 'active';}?>">About</a></li>
                        ...
                        <li class="dropdown visible-xs">
                            ...
                            <ul class="dropdown-menu no-border-radius" style="margin-left: -120px">
                                ...
                                <li class="width-100"><a href="<?php echo base_url('profile/followers') ?>?page=#followers"><?php echo $countFollowers ?> Followers</a></li>
                                <li class="width-100"><a href="<?php echo base_url('profile/following') ?>?page=#following">Following <?php echo $countFollowings ?></a></li>

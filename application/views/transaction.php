...
<section class="content" style="margin-top: 40px;padding: 0; background: url(<?php echo base_url('img/bg/money-bank.jpg')?>) no-repeat; background-size: cover;min-height: 500px">
            ...
            <div class="p-20" style="background: #FFF; min-height: 550px;">
                ...
                <section class="m-t-30">
                    ...
                    <div class="text-center m-b-40">
                        ...
                        <a href="<?php echo base_url('user/home')?>" class="btn btn-success no-border-radius bg-lg f-s-20"> Go to User Page</a>

                    </div>


                    <a class="label label-default pull-right" href="<?php echo base_url('upgrade')?>">
                        <span>TestAnother Transaction</span>
                    </a>

                    <a class="label label-primary" href="<?php echo base_url('user/home')?>">

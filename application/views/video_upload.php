...
<div class="container">
    ...
    <!-- The file upload form used as target for the file upload widget -->
        ...
        <?php echo form_open_multipart('upload/u_video',array('id'=>'fileupload'))?>
...
<script src="<?php echo base_url()?>js/upload_js/jquery.fileupload-ui.js"></script>
<!-- The main application script -->
<script src="<?php echo base_url()?>js/upload_js/main.js"></script>
<!-- The XDomainRequest Transport is included for cross-domain file deletion for IE 8 and IE 9 -->
<!--[if (gte IE 8)&(lt IE 10)]>
<script src="<?php echo base_url()?>js/upload_js/cors/jquery.xdr-transport.js"></script>
<![endif]-->
</body>
</html>
